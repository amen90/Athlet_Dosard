...
#define AI_NET_OBJ_INSTANCE g_athlet
 
#undef AI_ATHLET_MODEL_SIGNATURE
#define AI_ATHLET_MODEL_SIGNATURE     "0xc9dcf2ec709419a279623f4dd0a3d5b6"
...
#define AI_TOOLS_DATE_TIME   "2025-08-26T00:21:38+0200"

#undef AI_TOOLS_COMPILE_TIME
#define AI_TOOLS_COMPILE_TIME    __DATE__ " " __TIME__

#undef AI_ATHLET_N_BATCHES
#define AI_ATHLET_N_BATCHES         (1)

static ai_ptr g_athlet_activations_map[1] = AI_C_ARRAY_INIT;
static ai_ptr g_athlet_weights_map[1] = AI_C_ARRAY_INIT;
...
AI_NETWORK_OBJ_DECLARE(
  ...
  AI_BUFFER_INIT(AI_FLAG_NONE,  AI_BUFFER_FORMAT_U8,
    AI_BUFFER_SHAPE_INIT(AI_SHAPE_BCWH, 4, 1, 2948, 1, 1),
    2948, NULL, NULL),
  AI_BUFFER_INIT(AI_FLAG_NONE,  AI_BUFFER_FORMAT_U8,
    AI_BUFFER_SHAPE_INIT(AI_SHAPE_BCWH, 4, 1, 192, 1, 1),
    192, NULL, NULL),
  AI_TENSOR_LIST_IO_OBJ_INIT(AI_FLAG_NONE, AI_ATHLET_IN_NUM, &serving_default_keras_tensor0_output),
  AI_TENSOR_LIST_IO_OBJ_INIT(AI_FLAG_NONE, AI_ATHLET_OUT_NUM, &nl_3_output),
  &gemm_0_layer, 0xde75547b, NULL)
  ...
  ai_handle network, ai_network_report* report)
{
  ...
  {
    ai_network_report r = {
      .model_name        = AI_ATHLET_MODEL_NAME,
      .model_signature   = AI_ATHLET_MODEL_SIGNATURE,
...
AI_API_ENTRY
ai_buffer* ai_athlet_inputs_get(ai_handle network, ai_u16 *n_buffer)
{
...
AI_API_ENTRY
ai_buffer* ai_athlet_outputs_get(ai_handle network, ai_u16 *n_buffer)
{
  if (network == AI_HANDLE_NULL) {
    network = (ai_handle)&AI_NET_OBJ_INSTANCE;
    AI_NETWORK_OBJ(network)->magic = AI_MAGIC_CONTEXT_TOKEN;
...
AI_API_ENTRY
ai_i32 ai_athlet_forward(ai_handle network, const ai_buffer* input)
{
