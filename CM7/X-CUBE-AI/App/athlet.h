...
#include "athlet_config.h"
#include "ai_platform.h"

/******************************************************************************/
#define AI_ATHLET_MODEL_NAME          "athlet"
#define AI_ATHLET_ORIGIN_MODEL_NAME   "ath"

/******************************************************************************/
#define AI_ATHLET_ACTIVATIONS_ALIGNMENT   (4)
#define AI_ATHLET_INPUTS_IN_ACTIVATIONS   (4)
#define AI_ATHLET_OUTPUTS_IN_ACTIVATIONS  (4)

/******************************************************************************/
#define AI_ATHLET_IN_NUM        (1)

AI_DEPRECATED
#define AI_ATHLET_IN \
  ai_athlet_inputs_get(AI_HANDLE_NULL, NULL)

#define AI_ATHLET_IN_SIZE { \
  AI_ATHLET_IN_1_SIZE, \
}
#define AI_ATHLET_IN_SIZE_BYTES { \
  AI_ATHLET_IN_1_SIZE_BYTES, \
}
#define AI_ATHLET_IN_1_FORMAT      (AI_BUFFER_FORMAT_FLOAT)
#define AI_ATHLET_IN_1_CHANNEL     (5)
#define AI_ATHLET_IN_1_SIZE        (5)
#define AI_ATHLET_IN_1_SIZE_BYTES  (20)

/******************************************************************************/
#define AI_ATHLET_OUT_NUM       (1)

AI_DEPRECATED
#define AI_ATHLET_OUT \
  ai_athlet_outputs_get(AI_HANDLE_NULL, NULL)

#define AI_ATHLET_OUT_SIZE { \
  AI_ATHLET_OUT_1_SIZE, \
}
#define AI_ATHLET_OUT_SIZE_BYTES { \
  AI_ATHLET_OUT_1_SIZE_BYTES, \
}
#define AI_ATHLET_OUT_1_FORMAT      (AI_BUFFER_FORMAT_FLOAT)
#define AI_ATHLET_OUT_1_CHANNEL     (1)
#define AI_ATHLET_OUT_1_SIZE        (1)
#define AI_ATHLET_OUT_1_SIZE_BYTES  (4)

/******************************************************************************/
#define AI_ATHLET_N_NODES (6)
 ...
 */
AI_API_ENTRY
ai_handle ai_athlet_destroy(ai_handle network);
 ...
 * @ref ai_athlet_create. Both the activations memory buffer 
 ...
 */
AI_API_ENTRY
ai_buffer* ai_athlet_inputs_get(
 ...
 */
AI_API_ENTRY
ai_buffer* ai_athlet_outputs_get(
  ai_handle network, ai_u16 *n_buffer);
 ...
 * header generated by the code generation tool. See AI_ATHLET_*
 * defines into file @ref athlet.h for all network sizes defines
 *
 * @param network an opaque handle to the network context
